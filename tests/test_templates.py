...
def test_not_find_best_template(tmp_path, base_img_files):
    ...
    folder = base_img_files.files.get(StepEnum.BASE).path.parent
    root_filename = base_img_files.files.get(StepEnum.BASE).path.stem.split(i.CONVERT_PAGE_SEPARATOR)
